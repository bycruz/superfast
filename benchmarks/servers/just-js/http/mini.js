// just-js empty-200 HTTP server (from just-js/examples http/mini.js, with the
// port read from the PORT env var). Single-threaded epoll + io_uring server.
// Run by src/init.lua via the just runtime built in build.lua.
